...
glColor3f(1.0,1.0,1.0);
renderBitmapString(35,85,0,GLUT_BITMAP_HELVETICA_18,"RV COLLEGE OF ENGINEERING");
renderBitmapString(41,80,0,GLUT_BITMAP_HELVETICA_12,"Bangalore, Karnataka-560059");
glColor3f(1.0,1.0,0.0);
renderBitmapString(20,65,0,GLUT_BITMAP_8_BY_13,"CG PART-B");
...
bspd+=0.1;//increase block_dx_speed by 0.01
}
...
glColor3f(1.0,0.0,0.0);
glRectf(b1x,b1y,b1x+5,b1y+20);//block 1
glPopMatrix();
glutSwapBuffers();
glFlush();
}
